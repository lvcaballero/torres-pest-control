...
describe("Stock In expiry date", () => {
  ...
  it("sends the date with the line", async () => {
...
describe("expiryHint", () => {
  ...
  it("otherwise says it replaces the item's date", () => {
    expect(expiryHint("2027-09-25", "2026-09-25")).toBe("Replaces the item's expiry date.");
  });
});
