...
create or replace function public.get_session_user(session_token uuid)
returns users
language sql
stable
security definer
...
revoke all on function public.get_session_user(uuid) from public, anon, authenticated;
