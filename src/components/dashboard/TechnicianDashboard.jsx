        ...
        <div style={{ display: "grid", gridTemplateColumns: "minmax(0, 1.35fr) minmax(280px, 1fr)", gap: "1rem", alignItems: "start" }}>
          ...
          <Panel title="Field tools" action="Quick access">
            <div style={{ display: "grid", gap: "0.55rem" }}>
              <Link to="/scheduling" style={{ display: "flex", alignItems: "center", gap: "0.65rem", padding: "0.65rem 0.7rem", borderRadius: "3.75px", background: "#faf0e2", color: "#9a3412", textDecoration: "none", fontSize: "0.78rem", fontWeight: 500 }}>
                <ClipboardCheck size={16} /> Open service reports <ArrowRight size={14} style={{ marginLeft: "auto" }} />
              </Link>
              <Link to="/clients" style={{ display: "flex", alignItems: "center", gap: "0.65rem", padding: "0.65rem 0.7rem", borderRadius: "3.75px", background: "#f0f9f5", color: "#4a6b4a", textDecoration: "none", fontSize: "0.78rem", fontWeight: 500 }}>
                <MapPinned size={16} /> Find client history <ArrowRight size={14} style={{ marginLeft: "auto" }} />
              </Link>
              <Link to="/inventory" style={{ display: "flex", alignItems: "center", gap: "0.65rem", padding: "0.65rem 0.7rem", borderRadius: "3.75px", background: colors.sunken, color: colors.body, textDecoration: "none", fontSize: "0.78rem", fontWeight: 500 }}>
